...
export default function Bio() {
  ...
  return (
    <div id="container">
      <div id="nav-bar">
        <a href="https://arkadiuszkornecki.github.io/">
        ...
        <div id="menu" className={menuOpen ? "menu open" : "menu"}>
          <ul>
            ...
            <li>
              <HashLink to="#aboutme" onClick={() => setMenuOpen(false)}>
                ABOUT
              </HashLink>
            </li>
            <li>
              <HashLink to="#service" onClick={() => setMenuOpen(false)}>
                SERVICE
              </HashLink>
            </li>
            <li>
              <HashLink to="#experiences" onClick={() => setMenuOpen(false)}>
                EXPERIENCE
              </HashLink>
            </li>
            <li>
      ...
      <div id="home">
        ...
        <div id="about">
          ...
          <button type="button" className="contact_us_home">
      ...
      <div id="aboutme">
        ...
        <div id="description">
          ...
          <p>
            I'm still learning Python. In the future I'm going to be
      ...
      <div id="service">
        ...
        <div id="service_section">
          ...
          <div className="service_item">
            ...
            <p>
              I know HTML, CSS, JavaScript and basics of PHP, React, TypeScript
              and Tailwind
            </p>
          </div>
          <div className="service_item">
            ...
            <p>
              I write in Python using frameworks
              <br />
              like Django or Flask
              <br /> - <b>still learning</b>
            </p>
          </div>
        </div>
      </div>
      ...
      <div id="footer">
        <div id="footer_items">
          <a href="https://github.com/arkadiuszkornecki">
